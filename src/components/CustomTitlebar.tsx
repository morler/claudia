...
export const CustomTitlebar: React.FC<CustomTitlebarProps> = ({
  ...
  return (
    ...
    >
      {/* Left side - Platform-specific window controls */}
      <div className="flex items-center space-x-2 pl-5">
        {/* macOS Traffic Light buttons - only show on macOS and Linux */}
        {platform !== 'windows' && (
        ...
        {/* Windows - show app title or logo instead */}
        {platform === 'windows' && (
          <div className="flex items-center">
            <span className="text-sm font-medium text-foreground/80">Claudia</span>
          </div>
        )}
      </div>
